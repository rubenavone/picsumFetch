...
class Card {
    ...
    resizeImage(imageUrl, imageWidth, imgHeight) {
        console.log(imageWidth +" "+ imgHeight)
        console.log("avant" + imageUrl)
        imageUrl = imageUrl.replace(imageWidth, "600").replace(imgHeight, "600");
        console.log("après" + imageUrl)
        return imageUrl;
    }
